...
```{r fig_tsne, fig.height = 4.5, fig.cap = "Figure. t-SNE plots with median-centered data and using one minus Spearman correlation distance metric. (A) After non-specific gene-filtering, and (B) based on the fifty PAM50 genes. t-SNE: t-distributed stochastic neighbour embedding."}
