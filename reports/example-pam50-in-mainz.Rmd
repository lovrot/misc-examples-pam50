...
**Figure 2.**
Excess distant metastases in relation to PAM50 (A) intrinsic subtype and (B) proliferation index.
...
**Figure 3.**
Corresponding Kaplan-Meier curves. The PAM50 proliferation index is categorised into quarters.
...
**Figure 4.**
Proliferation, intrinsic subtype and outcome.
...
**Figure 6.** 
Concordance indices to assess the added value of ROR-S beyond standard clinical-pathological prognosticators as represented by the Nottingham prognostic index (NPI) in (A) ER+ patients and (B) ER+/not H2 patients.
...
**Table 1.**
Likelihood ratio tests to assess the added value of ROR-S beyond NPI in the sub-populations ER+ patients and ER+/not H2 patients.
