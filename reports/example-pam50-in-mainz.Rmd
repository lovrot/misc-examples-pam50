---
title: "Example: PAM50 in the Mainz dataset"
author: "John Lövrot"
...
A smoother with exploratory confidence bands is superimposed in the scatterplot and the contributions from individual patients are shown with circles. 
...
Corresponding plot for PAM50 intrinsic subtypes are added for comparison.
...
```{r, fig.width=8, fig.height=5.5, fig.cap="Corresponding Kaplan-Meier curves. Proliferation index categorised into quarters."}
...
caption(xtab) <- "Likelihood ratio (LR) tests to assess the added value of ROR-S beyond standard clinical-pathological prognosticators as represented by the Nottingham prognostic index (NPI) in ER+ patients."
