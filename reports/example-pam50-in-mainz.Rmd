...
survplot(Surv(survdmtm/365.25*12, dmstat) ~ subtypecd, 
    data=pData(mainz), 
    col=colCGANsubtypecd[levels(mainz$subtypecd)], lwd=1, xmax=7, bty="n", 
...
```{r, fig.width=12, fig.height=6, fig.fullwidth=TRUE, fig.cap="Figure 4. Proliferation, intrinsic subtype and outcome."}
ylim0 <- range(mainz$excessdm)
