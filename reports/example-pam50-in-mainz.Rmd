...
out <- knitr::kable(
    summary(pData(mainz)[, c("tumsize", "lnstat", "erstat", "histgr", "subtypecd")], 
        digits=2), 
    caption="Table 1. Clinial-pathological characteristics of the Mainz cohort.")
gsub('NA', '  ', out)
```
...
```{r, fig.height=6.5, fig.cap="Figure 3. Corresponding Kaplan-Meier curves. The PAM50 proliferation index is categorised into quarters."}
...
```{r, fig.width=12, fig.height=6, fig.cap="Figure 4. Proliferation, intrinsic subtype and outcome."}
ylim0 <- range(mainz$excessdm)
...
knitr::kable(lr_test_df, digits=3, row.names=FALSE, 
    caption="Table 2. Likelihood ratio tests to assess the added value of ROR-S beyond NPI in the sub-populations ER+ patients and ER+/not H2 patients.")
```
