...
knitr::opts_chunk$set(fig.path='graphics/example-pam50-in-mainz-pdf-', 
...
```{r, fig.height=4, fig.cap="Excess distant metastases in relation to PAM50 (A) intrinsic subtype and (B) proliferation index."}
...
```{r, fig.height=5.5, fig.cap="Corresponding Kaplan-Meier curves. The PAM50 proliferation index is categorised into quarters."}
...
```{r, fig.height=4, fig.margin=FALSE, fig.cap="Concordance indices to assess the added value of ROR-S beyond standard clinical-pathological prognosticators as represented by the Nottingham prognostic index (NPI) in (A) ER+ patients and (B) ER+/not H2 patients."}
