...
In these notes, we use the Mainz cohort of primary breast cancer patients [@Schmidt2008]. It is a population based cohort. Lymph node negative disease, no adjuvant therapy.
...
Since the Mainz dataset is a cohort of patients not receiving systemic therapy after surgery, the associations with outcome we observe are pure prognostic. For an introduction to the difference between prognostic and therapy predictive biomarkers, see, for example, the editorial by @Ballman2015. A biomarker can of course also be both prognostic and therapy predictive. An example is HER2 status.
...
See, for example, section "Prognostic Signatures Within Intrinsic Subtypes" of the review by @Ades2014.

### Added value of ROR score in ER+ patients

One should judge a candidate biomarker by its ability to improve prognostic/predictive accuracy beyond known prognosicators/predictors, see, for example, the editorial by @Kattan2003.
...
Formal statistical inference, compare with, for example, @Dowsett2013:
...
Copyright &copy; 2015 by John Lövrot.
