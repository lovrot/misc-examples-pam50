...
Since the Mainz dataset is a cohort of patients not receiving systemic therapy after surgery, the associations with outcome we observe are pure prognostic. For an introduction to the difference a prognostic and therapy predictive biomarkers, see, for example, the editorial by Ballman15JCO (DOI: [10.1200/JCO.2015.63.3651](http://dx.doi.org/10.1200/JCO.2015.63.3651)). A biomarker can of course also be both prognostic and therapy predictive. An example is HER2 status.
