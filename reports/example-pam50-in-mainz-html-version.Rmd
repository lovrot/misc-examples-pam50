...
```{r, fig.height=4, fig.cap="Figure 2. Excess distant metastases in relation to PAM50 (A) intrinsic subtype and (B) proliferation index."}
...
```{r, fig.height=5.5, fig.cap="Figure 3. Corresponding Kaplan-Meier curves. The PAM50 proliferation index is categorised into quarters."}
...
```{r, fig.height=4, fig.cap="Figure 6. Concordance indices to assess the added value of ROR-S beyond standard clinical-pathological prognosticators as represented by the Nottingham prognostic index (NPI) in (A) ER+ patients and (B) ER+/not H2 patients."}
